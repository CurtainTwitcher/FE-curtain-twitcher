...
const CrimeChartList = props => {
  return (
    <div>
    <BootstrapTable data={dummy}  striped={true} hover={true} condensed= {true} pagination={true} >
    <TableHeaderColumn isKey dataField="crimeType" filter={ { type: 'SelectFilter', options: crimeTypes }} width='300'>Crime Type{" "}</TableHeaderColumn>
